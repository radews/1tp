...
## _contractor: Szymon Rzeszotarski_
...
## Abstract 
The project concerns a system for recording working time. The system will record the amount of time spent working, from the moment of logging on to the moment of logging off.
...
> I am personally responsible for its operation: Szymon Rzeszotarski.
